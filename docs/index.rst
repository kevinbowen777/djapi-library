djapi-library - A library API built with the Django REST framework
==================================================================
...
To install the djapi-library project,
...
To run djapi-library, locally, enter the following on the command line:
...
----------------------------------------
`kbowen-djapi-library <https://kbowen-djapi-library.herokuapp.com/>`_

Reporting Bugs
--------------

Visit the djapi-library `Issues page <https://github.com/kevinbowen777/djapi-library/issues>`_ on GitHub.
